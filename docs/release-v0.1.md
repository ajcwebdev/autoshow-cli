...
[`extract`](./commands/extract.md) transcribes media, OCRs documents and images, extracts articles, and reports on X Spaces without running hosted LLM writing. Outputs include transcripts or extraction text, optional transcript videos, and `manifest.json`.
