...
Local `.html`/`.htm` files classify as `html_article`. `.acsm` is unsupported. Supported document and image extensions are listed in [extract input routing](../commands/02-extract/overview.md#input-routing).
