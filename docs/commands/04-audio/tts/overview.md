...
| `--tts-response-format <provider=value\|value>`          | Provider source audio format (Gemini `wav\|pcm\|mulaw\|alaw`; Mistral `wav\|mp3\|flac\|opus`; ElevenLabs `mp3_44100_128\|mp3_44100_192\|wav_44100\|wav_48000`) |
...
bun autoshow tts test/test-cases/e2e/service/audio/tts/fixtures/two-speaker.txt \
...
- ⚠️ spoken-text markup inside the synthesis input: ElevenLabs audio tags, Grok/Soniox speech tags, Speechify SSML. Inworld also accepts inline steering tags in addition to `--tts-instructions`.
...
| ----------------------------------- | ------------ | --------------------------- | ----------------------- | -------------------- | ------------------ | ------------------ | ----- | ------ | --------------- | ----------------------------------- | --------- |
| Gemini `gemini-3.8-flash-tts`       | ✅ 2026-09-22 | ✅ Style metadata            | ⚠️ Qualitative only     | ⚠️ Inline pauses     | ✅ Auto, 130        | ✅ Two stock voices | ✅     | ✅      | ✅ Consent audio | $0.50 text / $9 audio per M tokens  | 7/9       |
| Gemini `gemini-3.8-flash-lite-tts`  | ✅ 2026-09-22 | ✅ Style metadata            | ⚠️ Qualitative only     | ⚠️ Inline pauses     | ✅ Auto, 101        | ✅ Two stock voices | ✅     | ✅      | ✅ Consent audio | $0.50 text / $6 audio per M tokens  | 3/9       |
| Soniox `tts-rt-v2`                  | ✅ 2026-08-11 | ⚠️ Native inline tags       | ✅ `--tts-speed` 0.7–1.3 | ⚠️ Native pause tags | ✅ `--tts-language` | ❌ Local assembly   | ✅     | ❌      | ⚠️ Existing IDs | $4 text / $21.50 audio per M tokens | 4/9       |
...
| Inworld `realtime-tts-2`            | ✅ 2026-05-05 | ✅ `--tts-instructions`      | ✅ `--tts-speed` 0.5–1.5 | ✅ SSML breaks        | ❌ Not exposed      | ❌ Local assembly   | ✅     | ✅      | ✅               | `$0.025` / 1K chars                 | 8/9       |
| Grok `grok-tts`                     | ✅ 2026-04    | ⚠️ Speech tags              | ✅ `--tts-speed` 0.7–1.5 | ⚠️ `[pause]` tags    | ✅ `--tts-language` | ❌ Local assembly   | ✅     | ❌      | ✅               | `$0.015` / 1K chars                 | 5/9       |
| Mistral `voxtral-mini-tts-2603`     | ⚠️ 2026-03   | ❌ Not exposed               | ❌ Not exposed           | ❌ Not exposed        | ❌ Not exposed      | ❌ Local assembly   | ✅     | ❌      | ✅               | `$0.016` / 1K output chars          | 6/9       |
| ElevenLabs `eleven_v3`              | ⚠️ 2026-02   | ⚠️ Audio tags               | ❌ Not exposed           | ⚠️ Audio tags        | ✅ `--tts-language` | ✅ Up to 10 voices  | ✅     | ✅      | ✅               | `$0.10` / 1K chars                  | 9/9       |
