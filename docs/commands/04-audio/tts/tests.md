...
Provider-backed text-to-speech coverage for the `tts` command: Cartesia, ElevenLabs, Grok, Hume, Inworld, Mistral, OpenAI, and Speechify. These `bun t` commands may call paid or quota-limited providers.
