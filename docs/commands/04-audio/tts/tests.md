...
- `test/test-cases/e2e/service/audio/tts/` covers live synthesis for ElevenLabs, Grok, Mistral, OpenAI, Speechify, Hume, Cartesia, and Inworld.
- `test/test-cases/price-flag/audio/tts/tts-price/` covers `--price` validation.
