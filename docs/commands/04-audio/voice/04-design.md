...
| `--candidates <n>`                  | Number of candidates to generate                                                                       |
| `--seed <n>`                        | Optional non-negative deterministic seed                                                               |
| `--source-voice-id <id>`            | ElevenLabs remix source voice ID                                                                       |
| `--eligibility-snapshot-hash <sha>` | ElevenLabs remix eligibility SHA-256                                                                   |
...
| `--reconcile`                       | Complete an interrupted `--save` without creating another voice                                        |
