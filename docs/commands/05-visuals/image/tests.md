...
- `test/test-cases/e2e/service/visuals/image/` covers live generation for BFL, fal.ai, Gemini, Grok, Luma Labs, OpenAI, and Replicate.
- `test/test-cases/price-flag/visuals/image/image-price.test.ts` covers `--price` validation.
