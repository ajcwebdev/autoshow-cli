...
Most selectors support text-to-video; fal Seedance and H3 Max expose text, image, and reference as separate routes. Image-to-video is available on every provider, including those fal image routes.

✅ supported, ❌ not supported. Max resolution: ✅ 2K/4K, ⚠️ 1080p, ❌ 720p. Duration: ✅ 15s+, ⚠️ max 10s, ❌ max 8s. Aspect ratio: ✅ any/7+, ⚠️ 5–6, ❌ 3 or fewer / input frame. References: ❌ none, ⚠️ up to 3, ✅ 4 or more. Rows are newest first. Released dates are provider announcement or model-origin dates. Recency marks: ✅ 2026-04-01 or later, ⚠️ 2026-01-01 through 2026-03-31, ❌ before 2026-01-01. Outputs are the default per-second (or per-clip) estimate. Inputs are extra billed reference or token cost when published separately; `Included` means the published rate is per output second. Output pricing: ✅ cheapest third, ⚠️ middle third, ❌ most expensive third. Cost rank is cheapest first on the default billed rate (1 = cheapest); ties share a rank.
...
| LTX `ltx-2-5-fast`                                 | ✅ 2026-08    | ❌                  | ✅           | ❌    | ❌      | ✅ 6–20s at 720p/1080p; 6–10s at 1440p/4K | ✅ 4K           | ❌ 16:9 or 9:16 | ✅ Always on           | ❌ No       | Included                                                | ⚠️ $0.09/$0.13/$0.19/$0.30 per second at 720p/1080p/1440p/4K | 11/17     |
| LTX `ltx-2-5-pro`                                  | ✅ 2026-08    | ❌                  | ✅           | ❌    | ❌      | ⚠️ 6–10s                                 | ✅ 4K           | ❌ 16:9 or 9:16 | ✅ Always on           | ❌ No       | Included                                                | ❌ $0.12/$0.17/$0.25/$0.39 per second at 720p/1080p/1440p/4K  | 13/17     |
...
| Replicate `bytedance/seedance-2.5`                 | ✅ 2026-07-31 | ✅                  | ✅           | ❌    | ❌      | ✅ 4–30s or −1                            | ❌ 720p         | ✅ 7 ratios     | ✅ Always on           | ✅ Up to 30 | $0.4304/$0.9676 per second at 480p/720p with video refs | ⚠️ $0.1028/$0.2312 per second at 480p/720p                   | 10/17     |
| Replicate `alibaba/happyhorse-1.1`                 | ✅ 2026-06-22 | ✅                  | ❌           | ❌    | ❌      | ✅ 3–15s                                  | ⚠️ 1080p       | ⚠️ 5 ratios    | ❌ No                  | ✅ Up to 9  | Included                                                | ⚠️ $0.14/s at 720p ($0.18 at 1080p)                          | 12/17     |
