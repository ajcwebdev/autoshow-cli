...
This report is one of eight per-modality records split on 2026-08-19 from the former consolidated 2026 hosted-model refresh ledger (retired as an ADR; the remaining ADRs were renumbered to close the gap). Sibling reports: [OCR](../text/ocr/model-report.md), [URL scraping](../text/url/model-report.md), [LLMs](../text/write/model-report.md), [TTS](../audio/tts/model-report.md), [Music](../audio/music/model-report.md), [Image](../visuals/image/model-report.md), [Video](../visuals/video/model-report.md).
...
- STT provider adapters: `src/cli/commands/stt/`
