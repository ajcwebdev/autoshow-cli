...
- Backfill existing STT outputs with top-level [`resume`](../setup-and-utilities/resume.md).

See the [model report](model-report.md) for historical model changes and the [testing guide](tests.md) for verification coverage.
