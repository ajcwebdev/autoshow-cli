...
| `--reference-image <path-or-url>`              | Reference image for `reference-to-video`; repeatable, with per-model limits in [Provider Capabilities](#provider-capabilities)                                                         |
...
- Gemini `1080p`, `4k`, reference-image, and extension requests are normalized to 8 seconds. Extensions also force 720p.
...
- Extend durations clamp to 1–10 seconds (default 6). Extend does not apply `--aspect-ratio` or `--resolution`.
...
- Seedance `--duration -1` selects intelligent duration and is billed as 5 seconds.
...
- MiniMax H3 accepts up to 9 image, 3 video, and 3 audio references (max 12 combined). Native audio is always on.
...
| Replicate `pixverse/pixverse-v6`                                    | ✅ 2026-04-22 | ✅            | ✅             | ❌                 | ✅          | ❌   | ❌     | ✅ 5–15s               | ⚠️ 1080p       | ✅ 3 ratios     | ✅ `--generate-audio`                 | ❌ No      | $0.09/s at 720p ($0.05–$0.18 by resolution)                | 7/16          |
...
| Replicate `bytedance/seedance-2.0`                                  | ✅ 2026-02-12 | ✅            | ✅             | ✅                 | ✅          | ✅   | ✅     | ✅ −1–15s              | ⚠️ 1080p       | ✅ 8 ratios     | ✅ `--generate-audio`                 | ✅ Up to 9 | $0.18/s at 720p ($0.08 at 480p, $0.45 at 1080p)            | 14/16         |
...
| fal.ai `fal-ai/pixverse/c1`                                         | ✅ 2026       | ✅            | ✅             | ✅                 | ✅          | ❌   | ❌     | ✅ 1–15s               | ⚠️ 1080p       | ✅ 8 ratios     | ✅ `--generate-audio`                 | ✅ Up to 7 | $0.005/s                                                   | 1/16          |
