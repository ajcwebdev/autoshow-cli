...
| `--stt-preflight-concurrency <n>`      | Max duration probes in parallel during preflight; default `7`                                                                                                                                         |
...
Grok's `--stt-grok-verbatim` disables display formatting and requests filler words. These options, diarization, native subtitles, and DeepInfra response format persist in STT configuration and resume.
