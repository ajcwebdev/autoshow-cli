...
The 2026-08-16 text-catalog gap audit (recorded in the [LLM report](../../text/write/model-report.md)) also excluded `gemini-2.5-flash-image` and `imagen-4.0-*` as superseded image generations; Nano Banana 2 / Pro are already registered.
