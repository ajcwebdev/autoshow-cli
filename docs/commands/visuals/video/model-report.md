...
The 2026-08-16 text-catalog gap audit (recorded in the [LLM report](../../text/write/model-report.md)) also recorded the P3 video recommendation `gemini-omni-flash`, pending confirmation that the existing Veo adapter can host it.
...
- Video provider adapters: `src/cli/commands/visuals/video/`
