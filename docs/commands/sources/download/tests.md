...
- `test/test-cases/e2e/local/sources/download/download-input-types-local-file.test.ts` covers local document download and example audio.
- `test/test-cases/e2e/local/sources/download/download-input-types-direct-url.test.ts` covers hosted audio and video URLs plus URL-list batching.
- `test/test-cases/e2e/local/sources/download/download-input-types-feed-or-channel.test.ts` covers RSS feed batching.
- `test/test-cases/e2e/local/sources/download/download-input-types-streaming.test.ts` covers YouTube and Twitch URLs.
