...
This standalone report aggregates the two video benchmark runs dated 2026-05-21 directly from the existing `run.json` and `video-quality-report.json` files. No videos were regenerated and no judge was run.
