...
Updated 2026-09-25 after the [ADR-010 provider exclusions](../../adr/ADR-010-hosted-model-registry-lifecycle-and-capability-policy.md#excluded-integrations). 32 narration results across 8 models and four inputs, plus 15 controls results, remain selected (47 recordings). Recorded selected costs total $0.72662: narration $0.48600, controls $0.24062. Cost bases include provider usage, computed usage, and estimates; these are not confirmed invoices or total historical spending.
...
- [Emotion and delivery](./2026-09-12_05-tts-emotion/benchmark-report.md) — 6 cases.
- [Speed and pauses](./2026-09-12_06-tts-speed-pauses/benchmark-report.md) — 9 cases.
...
| ---- | --------------------------------- | -------- | ------------------ | ---------- |
| 1    | openai/gpt-4o-mini-tts-2025-12-15 | 4/4      | $0.01260           | $0.02734   |
| 2    | gemini/gemini-3.8-flash-lite-tts  | 4/4      | $0.01379           | $0.02992   |
| 3    | grok/grok-tts                     | 4/4      | $0.01500           | $0.03255   |
| 4    | mistral/voxtral-mini-tts-2603     | 4/4      | $0.01600           | $0.03472   |
| 5    | soniox/tts-rt-v2                  | 4/4      | $0.01779           | $0.03860   |
| 6    | gemini/gemini-3.8-flash-tts       | 4/4      | $0.02379           | $0.05162   |
| 7    | inworld/realtime-tts-2            | 4/4      | $0.02500           | $0.05425   |
| 8    | elevenlabs/eleven_v3              | 4/4      | $0.10000           | $0.21700   |
...
| 5    | elevenlabs/eleven_v3              | 2.23×                   | 4/4             |
| 6    | soniox/tts-rt-v2                  | 2.13×                   | 4/4             |
...
### Emotion and delivery benchmark

[Emotion and delivery report](./2026-09-12_05-tts-emotion/benchmark-report.md) — 6 retained cases. This standalone benchmark appears within the TTS dashboard tab. Mechanisms differ by provider, so this table records coverage and cost without a cross-provider ranking.

| Provider/model                   | Cases | Recorded cost |
| -------------------------------- | ----- | ------------- |
| elevenlabs/eleven_v3             | 1     | $0.07500      |
| gemini/gemini-3.8-flash-lite-tts | 1     | $0.00393      |
| gemini/gemini-3.8-flash-tts      | 1     | $0.00580      |
| grok/grok-tts                    | 1     | $0.00387      |
| inworld/realtime-tts-2           | 1     | $0.00400      |
| soniox/tts-rt-v2                 | 1     | $0.00276      |

### Speed and pauses benchmark

[Speed and pauses report](./2026-09-12_06-tts-speed-pauses/benchmark-report.md) — 9 retained cases. This standalone benchmark appears within the TTS dashboard tab. Mechanisms differ by provider, so this table records coverage and cost without a cross-provider ranking.

| Provider/model                   | Cases | Recorded cost |
| -------------------------------- | ----- | ------------- |
| elevenlabs/eleven_v3             | 1     | $0.06900      |
| gemini/gemini-3.8-flash-lite-tts | 1     | $0.00674      |
| gemini/gemini-3.8-flash-tts      | 1     | $0.00894      |
| grok/grok-tts                    | 2     | $0.00728      |
| inworld/realtime-tts-2           | 2     | $0.04379      |
| soniox/tts-rt-v2                 | 2     | $0.00949      |
...
[Filtered manifest evidence](./2026-09-12-benchmark-report.evidence.zip) contains the retained original batch items and an updated SHA256SUMS manifest. It is a filtered derivative, not the original batch manifest. Its manifest SHA-256 is `37a40b4517088b95159bffdd8f92aade54fc40aea9faf6a71d21bcd9475589fa`. Newer narration results remain in their per-run manifests; controls retain their summary reports. Ignored local audio and runtime outputs were preserved.
