...
- Run directory: `/Users/ajc/c/auto/autoshow-cli/docs/benchmarks/stt-with-speakers/2023-04-05-jsjam-react-miami-2023-10-minutes`
...
| 3 | <code>speechmatics-melia-1</code> | $0.0215 | 94.84 | 5.16% | 5.04% | supported | 4.97s | 120.82× realtime | $0.0215 |
| 4 | <code>mistral-voxtral-mini-2602</code> | $0.0300 | 94.78 | 5.22% | 4.86% | supported | 10.01s | 59.95× realtime | $0.0300 |
| 5 | <code>assemblyai-universal-3-5-pro</code> | $0.0383 | 97.69 | 2.31% | 2.28% | supported | 17.10s | 35.08× realtime | $0.0383 |
| 6 | <code>deepgram-nova-3</code> | $0.0430 | 93.30 | 6.70% | 6.30% | supported | 2.93s | 204.99× realtime | $0.0430 |
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | $0.0500 | 94.43 | 5.57% | 5.58% | supported | 23.18s | 25.88× realtime | $0.0500 |
| 8 | <code>happyscribe-auto</code> | $0.1000 | 97.04 | 2.96% | 2.70% | supported | 71.37s | 8.41× realtime | $0.1000 |
| 9 | <code>gladia-solaria-3</code> | $0.1017 | 94.90 | 5.10% | 4.98% | supported | 10.71s | 56.05× realtime | $0.1017 |

#### Speed

| Rank | Provider | Value | Score / 100 | Speaker-aware WER | Text-only WER | Diarization | Processing Time | Throughput | Actual Cost |
| ---: | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| 1 | <code>deepgram-nova-3</code> | 2.93s | 93.30 | 6.70% | 6.30% | supported | 2.93s | 204.99× realtime | $0.0430 |
...
| 4 | <code>mistral-voxtral-mini-2602</code> | 10.01s | 94.78 | 5.22% | 4.86% | supported | 10.01s | 59.95× realtime | $0.0300 |
...
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | 23.18s | 94.43 | 5.57% | 5.58% | supported | 23.18s | 25.88× realtime | $0.0500 |
| 8 | <code>soniox-stt-async-v5</code> | 26.75s | 94.72 | 5.28% | 5.22% | supported | 26.75s | 22.43× realtime | $0.0167 |
| 9 | <code>happyscribe-auto</code> | 71.37s | 97.04 | 2.96% | 2.70% | supported | 71.37s | 8.41× realtime | $0.1000 |
...
| 5 | <code>mistral-voxtral-mini-2602</code> | 94.78/100 quality score | 94.78 | 5.22% | 4.86% | supported | 10.01s | 59.95× realtime | $0.0300 |
| 6 | <code>soniox-stt-async-v5</code> | 94.72/100 quality score | 94.72 | 5.28% | 5.22% | supported | 26.75s | 22.43× realtime | $0.0167 |
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | 94.43/100 quality score | 94.43 | 5.57% | 5.58% | supported | 23.18s | 25.88× realtime | $0.0500 |
| 8 | <code>deepgram-nova-3</code> | 93.30/100 quality score | 93.30 | 6.70% | 6.30% | supported | 2.93s | 204.99× realtime | $0.0430 |
| 9 | <code>grok-speech-to-text</code> | 91.82/100 quality score | 91.82 | 8.18% | 7.98% | supported | 5.98s | 100.32× realtime | $0.0167 |
...
| <code>deepgram-nova-3</code> | Third-Party Service Diarization | supported | 93.30 | 6.70% | 6.30% | 2.93s | 204.99× realtime | $0.0430 |
| <code>gemini-stt-gemini-3.5-transcribe</code> | Third-Party Service Diarization | supported | 94.43 | 5.57% | 5.58% | 23.18s | 25.88× realtime | $0.0500 |
...
| <code>mistral-voxtral-mini-2602</code> | Third-Party Service Diarization | supported | 94.78 | 5.22% | 4.86% | 10.01s | 59.95× realtime | $0.0300 |
...
| <code>gemini-stt-gemini-3.5-transcribe</code> | 35 | 10 | 49 | 1687 |
...
| <code>gemini-stt-gemini-3.5-transcribe</code> | 35 | 10 | 48 | 1667 |
