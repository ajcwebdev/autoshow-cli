...
- Run directory: `/Users/ajc/c/auto/autoshow-cli/docs/benchmarks/stt-with-speakers/2022-09-30-widgets-fsjam-40-minutes`
...
| 3 | <code>speechmatics-melia-1</code> | $0.0868 | 96.45 | 3.55% | 3.37% | supported | 22.74s | 106.54× realtime | $0.0868 |
| 4 | <code>mistral-voxtral-mini-2602</code> | $0.1212 | 97.23 | 2.77% | 2.57% | supported | 33.26s | 72.84× realtime | $0.1212 |
| 5 | <code>assemblyai-universal-3-5-pro</code> | $0.1548 | 98.09 | 1.91% | 1.70% | supported | 45.53s | 53.21× realtime | $0.1548 |
| 6 | <code>deepgram-nova-3</code> | $0.1737 | 95.20 | 4.80% | 3.81% | supported | 8.93s | 271.37× realtime | $0.1737 |
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | $0.2019 | 93.79 | 6.21% | 5.55% | supported | 103.06s | 23.51× realtime | $0.2019 |
| 8 | <code>happyscribe-auto</code> | $0.4038 | 97.95 | 2.05% | 1.85% | supported | 124.01s | 19.54× realtime | $0.4038 |
| 9 | <code>gladia-solaria-3</code> | $0.4106 | 96.80 | 3.20% | 2.99% | supported | 39.28s | 61.69× realtime | $0.4106 |

#### Speed

| Rank | Provider | Value | Score / 100 | Speaker-aware WER | Text-only WER | Diarization | Processing Time | Throughput | Actual Cost |
| ---: | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| 1 | <code>deepgram-nova-3</code> | 8.93s | 95.20 | 4.80% | 3.81% | supported | 8.93s | 271.37× realtime | $0.1737 |
...
| 4 | <code>mistral-voxtral-mini-2602</code> | 33.26s | 97.23 | 2.77% | 2.57% | supported | 33.26s | 72.84× realtime | $0.1212 |
...
| 8 | <code>gemini-stt-gemini-3.5-transcribe</code> | 103.06s | 93.79 | 6.21% | 5.55% | supported | 103.06s | 23.51× realtime | $0.2019 |
| 9 | <code>happyscribe-auto</code> | 124.01s | 97.95 | 2.05% | 1.85% | supported | 124.01s | 19.54× realtime | $0.4038 |
...
| 3 | <code>mistral-voxtral-mini-2602</code> | 97.23/100 quality score | 97.23 | 2.77% | 2.57% | supported | 33.26s | 72.84× realtime | $0.1212 |
...
| 7 | <code>deepgram-nova-3</code> | 95.20/100 quality score | 95.20 | 4.80% | 3.81% | supported | 8.93s | 271.37× realtime | $0.1737 |
| 8 | <code>gemini-stt-gemini-3.5-transcribe</code> | 93.79/100 quality score | 93.79 | 6.21% | 5.55% | supported | 103.06s | 23.51× realtime | $0.2019 |
| 9 | <code>grok-speech-to-text</code> | 92.04/100 quality score | 92.04 | 7.96% | 7.51% | supported | 29.32s | 82.64× realtime | $0.0673 |
...
| <code>deepgram-nova-3</code> | Third-Party Service Diarization | supported | 95.20 | 4.80% | 3.81% | 8.93s | 271.37× realtime | $0.1737 |
| <code>gemini-stt-gemini-3.5-transcribe</code> | Third-Party Service Diarization | supported | 93.79 | 6.21% | 5.55% | 103.06s | 23.51× realtime | $0.2019 |
...
| <code>mistral-voxtral-mini-2602</code> | Third-Party Service Diarization | supported | 97.23 | 2.77% | 2.57% | 33.26s | 72.84× realtime | $0.1212 |
...
| <code>gemini-stt-gemini-3.5-transcribe</code> | 133 | 200 | 178 | 8229 |
...
| <code>gemini-stt-gemini-3.5-transcribe</code> | 129 | 149 | 175 | 8163 |
