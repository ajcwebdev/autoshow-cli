...
- Root directory: `/Users/ajc/c/auto/autoshow-cli/docs/benchmarks/stt-with-speakers`
- Runs aggregated: 4
  - `1-audio` (9 providers)
  - `2022-09-30-widgets-fsjam-40-minutes` (9 providers)
  - `2023-03-15-jsjam-qwik-misko-hevery` (9 providers)
  - `2023-04-05-jsjam-react-miami-2023-10-minutes` (9 providers)
- Distinct providers: 9 (0 local, 0 third-party non-diarization, 9 third-party diarization)
...
| 3 | <code>speechmatics-melia-1</code> | $0.0883 | 4 | 95.40 | 4.60% | 4.50% | supported | 19.70s | 125.04× | $0.0883 |
| 4 | <code>mistral-voxtral-mini-2602</code> | $0.1232 | 4 | 95.75 | 4.25% | 4.09% | supported | 30.29s | 81.33× | $0.1232 |
| 5 | <code>assemblyai-universal-3-5-pro</code> | $0.1574 | 4 | 98.09 | 1.91% | 1.77% | supported | 36.43s | 67.63× | $0.1574 |
| 6 | <code>deepgram-nova-3</code> | $0.1766 | 4 | 92.82 | 7.18% | 6.32% | supported | 7.78s | 316.56× | $0.1766 |
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | $0.2053 | 4 | 93.24 | 6.76% | 6.56% | supported | 98.88s | 24.92× | $0.2053 |
| 8 | <code>happyscribe-auto</code> | $0.4106 | 4 | 97.75 | 2.25% | 2.01% | supported | 93.53s | 26.34× | $0.4106 |
| 9 | <code>gladia-solaria-3</code> | $0.4175 | 4 | 95.49 | 4.51% | 4.38% | supported | 33.78s | 72.94× | $0.4175 |

#### Speed

| Rank | Provider | Value | Runs | Mean Score / 100 | Mean Speaker-aware WER | Mean Text-only WER | Diarization | Mean Speed | Throughput | Mean Cost |
| ---: | --- | ---: | ---: | ---: | ---: | ---: | --- | ---: | ---: | ---: |
| 1 | <code>deepgram-nova-3</code> | 7.78s | 4 | 92.82 | 7.18% | 6.32% | supported | 7.78s | 316.56× | $0.1766 |
...
| 4 | <code>mistral-voxtral-mini-2602</code> | 30.29s | 4 | 95.75 | 4.25% | 4.09% | supported | 30.29s | 81.33× | $0.1232 |
...
| 9 | <code>gemini-stt-gemini-3.5-transcribe</code> | 98.88s | 4 | 93.24 | 6.76% | 6.56% | supported | 98.88s | 24.92× | $0.2053 |
...
| 3 | <code>mistral-voxtral-mini-2602</code> | 95.75/100 quality score | 4 | 95.75 | 4.25% | 4.09% | supported | 30.29s | 81.33× | $0.1232 |
...
| 7 | <code>gemini-stt-gemini-3.5-transcribe</code> | 93.24/100 quality score | 4 | 93.24 | 6.76% | 6.56% | supported | 98.88s | 24.92× | $0.2053 |
| 8 | <code>deepgram-nova-3</code> | 92.82/100 quality score | 4 | 92.82 | 7.18% | 6.32% | supported | 7.78s | 316.56× | $0.1766 |
| 9 | <code>grok-speech-to-text</code> | 89.73/100 quality score | 4 | 89.73 | 10.27% | 10.10% | supported | 26.94s | 91.44× | $0.0684 |
...
| <code>gemini-stt-gemini-3.5-transcribe</code> | 93.24 | 97.27 | 93.79 | 87.45 | 94.43 |
