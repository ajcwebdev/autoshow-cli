...
[00:06:53] [speaker-E] But yeah, so, um, that's the normal of using Twitter Spaces every day. Miami, and I'm just kind of crashing the party today, but I'm super excited to have Dev and, um, Anthony and Scott all as media partners for React Miami this year. And I'm also listening in, just interested to see what we're gonna do because we kind of like just them the green light to do whatever they like.
[00:07:25] [speaker-A] So yes, we'll see whether you end up regretting it. I think that will have some cool stuff in store. So you probably get back to your description, Dev.
