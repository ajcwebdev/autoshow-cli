...
The [raw response evidence archive](raw-responses.evidence.zip) preserves all 16 original provider response files and a `SHA256SUMS` manifest. The structured outputs, run manifest, and comparison results remain available as individual files.
