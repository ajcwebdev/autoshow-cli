...
- **Runtime:** Python 3.12, Torch 2.14.0, Transformers 4.57.6 at the time of this historical measurement. The current [TypeScript/ONNX workflow](../commands/02-extract/stt/workflows/timing/overview.md#force-align-supplied-text-locally) replaces that retired runtime; these measurements have not been re-established with ONNX.
...
- Extract command documentation: [`docs/commands/02-extract/overview.md`](../commands/02-extract/overview.md)
- OCR command documentation: [`docs/commands/02-extract/ocr/overview.md`](../commands/02-extract/ocr/overview.md)
- STT command documentation: [`docs/commands/02-extract/stt/overview.md`](../commands/02-extract/stt/overview.md)
- Local STT timing, alignment, and channels: [STT command guide — Local Timing and Speaker Workflows](../commands/02-extract/stt/workflows/timing/overview.md#local-timing-and-speaker-workflows)
