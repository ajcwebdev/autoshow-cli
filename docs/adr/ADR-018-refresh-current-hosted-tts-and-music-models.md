...
The active registries at decision time contained 23 selectors: 19 TTS and 4 music. A 2026-08-06 evidence refresh found legacy, superseded, or moving selectors and 11 current selector introductions worth exposing. The selected end state contains 29 selectors: 24 TTS and 5 music.
...
|---|---|---|---|
| **Refresh in separate TTS and music phases** | Keeps each registry, its provider adapters, tests, documentation, and verification together | Requires two implementation and verification passes | 2 phases; 11 selector introductions; 5 removals; 23 to 29 active selectors |
...
Phase 1 removes the four retired TTS selectors from active selection and adds nine canonical replacement or additive selectors for 24 active hosted TTS selectors.
...
- The active TTS and music selector surface grows from 23 to 29 entries, increasing help, documentation, and all-provider maintenance.
