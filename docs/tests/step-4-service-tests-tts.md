...
- Model-level service files under `test/test-cases/e2e/service/step-4-tts-e2e/tts-services/` cover Cartesia, Deepgram, DeepInfra, ElevenLabs, Gemini, Grok, Groq, Hume, Inworld, Kitten, MiniMax, Mistral, OpenAI, and Speechify, gated by their respective provider keys. The shared `defineTTSServiceTest` helper covers invalid model rejection and synthesis.
...
ElevenLabs IVC, Speechify custom voice, Hume, and Cartesia provide side-effect-free price coverage. The Kitten pipeline mapping is selected via `bun t test/test-cases/e2e/service/step-4-tts-e2e/tts-services/kitten-tts-pipeline.test.ts --price`.
