...
This report records the hosted text-model changes, including selector additions shared by the write and OCR registries. The OCR-specific service expansion and catalog audits are recorded in the [OCR report](model-refresh-ocr.md).
