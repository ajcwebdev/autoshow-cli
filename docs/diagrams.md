...
1. [System Overview & CLI Surface](diagrams/01-system-overview-cli.md) - High-level architecture, the 15-command native CLI surface, native dispatch and command routing, provider selectors, and global runtime flags such as config and model path
