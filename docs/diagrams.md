...
3. [Processing Pipelines](diagrams/03-processing-pipelines.md) - Media, document, article, transcript-video, lyric-video, write, and standalone generation paths from download/detect through extraction/transcription, LLM writing, and media generation
