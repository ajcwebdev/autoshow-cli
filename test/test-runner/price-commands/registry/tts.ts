...
export const ttsRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-4-tts-e2e/tts-services/cartesia-sonic-3.6-2026-08-27.test.ts', [
    command('tts-cartesia-sonic-3.6-2026-08-27', 'tts-cartesia-sonic-3.6-2026-08-27', ['src/cli/create-cli.ts', 'tts', 'test/test-cases/e2e/service/step-4-tts-e2e/tts-services/fixtures/natural-short.txt', '--provider', 'cartesia=sonic-3.6-2026-08-27', '--price']),
  ]),
  ...exact('test/test-cases/e2e/service/step-4-tts-e2e/tts-services/inworld-realtime-tts-2-flash.test.ts', [
    command('tts-inworld-realtime-tts-2-flash', 'tts-inworld-realtime-tts-2-flash', ['src/cli/create-cli.ts', 'tts', 'test/test-cases/e2e/service/step-4-tts-e2e/tts-services/fixtures/natural-short.txt', '--provider', 'inworld=realtime-tts-2-flash', '--price']),
  ]),
]
