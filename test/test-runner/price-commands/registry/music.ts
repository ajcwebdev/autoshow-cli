...
export const musicRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-7-music-gen-e2e/elevenlabs-music-v1-pipeline.test.ts', [
    command('music-pipeline-elevenlabs-music_v1', 'music-pipeline-elevenlabs-music_v1', ['src/cli/create-cli.ts', 'write', 'https://ajc.pics/autoshow/examples/1-audio.mp3', '--llm', 'groq=openai/gpt-oss-20b', '--music', 'elevenlabs=music_v1', '--music-duration', '3', '--price']),
  ]),
