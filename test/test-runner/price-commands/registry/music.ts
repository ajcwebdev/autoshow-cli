...
const minimaxGeminiMusicCommand = command(
  'music-multi-minimax-music-3.0-gemini-lyria-3.5',
  'music-multi-minimax-music-3.0-gemini-lyria-3.5',
  ['src/cli/create-cli.ts', 'music', 'bright acoustic pop with handclaps and a catchy chorus', '--provider', 'minimax=music-3.0', '--provider', 'gemini=lyria-3.5', '--lyrics-file', 'input/examples/tts/01-tts-short.md', '--price']
)
...
export const musicRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/audio/music/minimax-music-3.0-gemini-lyria-3.5.test.ts', [
    minimaxGeminiMusicCommand,
  ]),
