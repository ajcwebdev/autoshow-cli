...
const minimaxGeminiClipMusicCommand = command(
  'music-multi-minimax-music-3.0-gemini-lyria-3-clip-preview',
  'music-multi-minimax-music-3.0-gemini-lyria-3-clip-preview',
  ['src/cli/create-cli.ts', 'music', 'bright acoustic pop with handclaps and a catchy chorus', '--provider', 'minimax=music-3.0', '--provider', 'gemini=lyria-3-clip-preview', '--lyrics-file', 'input/examples/tts/1-tts.md', '--price']
)
...
export const musicRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-7-music-gen-e2e/minimax-music-3.0-gemini-lyria-3-clip-preview.test.ts', [
