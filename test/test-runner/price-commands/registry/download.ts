...
export const downloadRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/local/sources/download/download-input-types-streaming.test.ts', [
    reportOnly('transcribe-youtube-single', ['src/cli/create-cli.ts', 'extract', 'https://ajc.pics/autoshow/examples/2-video.mp4', '--provider', 'whisper=tiny', '--price']),
  ...
  ...exact('test/test-cases/e2e/local/sources/download/download-input-types-feed-or-channel.test.ts', [
    ...
    reportOnly('transcribe-youtube-channel-batch-1', ['src/cli/create-cli.ts', 'extract', 'input/examples/batch/2-urls.md', '--batch-limit', '2', '--provider', 'whisper=tiny', '--price']),
  ]),
]
