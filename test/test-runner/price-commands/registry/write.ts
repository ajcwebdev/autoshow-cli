...
export const writeRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-3-write-e2e/write-services/gemini-3.5-flash-lite.test.ts', [
    command('write-gemini-gemini-3.5-flash-lite', 'write-gemini-gemini-3.5-flash-lite', ['src/cli/create-cli.ts', 'write', 'https://ajc.pics/autoshow/examples/1-audio.mp3', '--llm', 'gemini=gemini-3.5-flash-lite', '--price']),
  ]),
