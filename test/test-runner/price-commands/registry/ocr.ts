...
export const ocrRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/service/text/ocr/mistral-ocr-2512.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/glm-ocr.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/openai-gpt-5.4-nano.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/deepinfra-qwen3-vl-30b-a3b-instruct.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/openai-gpt-5.5.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/grok-4.3.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/anthropic-claude-opus-4-8.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/text/ocr/anthropic-claude-sonnet-4-6.test.ts', [
    command('extract-anthropic-claude-sonnet-4-6', 'extract-anthropic-claude-sonnet-4-6', ['src/cli/create-cli.ts', 'extract', 'input/examples/document/1-document.pdf', '--provider', 'anthropic=claude-sonnet-4-6', '--price']),
  ]),
  ...exact('test/test-cases/e2e/service/text/ocr/gemini-3.1-pro-preview.test.ts', [
