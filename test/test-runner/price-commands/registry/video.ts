...
export const videoRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/service/visuals/video/gemini-veo-3.1-fast-generate-preview.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/gemini-veo-3.1-generate-preview.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/grok-imagine-video.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/ltx-2-3-fast.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/ltx-2-3-pro.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/replicate-kling-v3-video.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/replicate-kling-v3-omni-video.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/replicate-bytedance-seedance-2.0.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/replicate-bytedance-seedance-2.0-fast.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/video/fal-pixverse-c1.test.ts', [
