...
export const imageRegistry: PriceSelectionEntry[] = [
  ...exact('test/test-cases/e2e/service/visuals/image/openai-gpt-image-25.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/openai-gpt-image-2.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/gemini-image-gen.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/replicate-image.test.ts', [
    ...
    command('image-replicate-alibaba/qwen-image-3', 'image-replicate-alibaba/qwen-image-3', ['src/cli/create-cli.ts', 'image', 'A tiny red triangle icon centered on a white background', '--provider', 'replicate=alibaba/qwen-image-3', '--aspect-ratio', '1:1', '--price']),
    command('image-replicate-alibaba/qwen-image-3-pro', 'image-replicate-alibaba/qwen-image-3-pro', ['src/cli/create-cli.ts', 'image', 'A tiny yellow star icon centered on a white background', '--provider', 'replicate=alibaba/qwen-image-3-pro', '--aspect-ratio', '1:1', '--price']),
  ]),
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/lumalabs-uni-1-max.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/grok-imagine-image-2.0.test.ts', [
