...
export const imageRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/step-5-image-gen-e2e/replicate-image.test.ts', [
    ...
    command('image-replicate-ideogram-ai/ideogram-v4-turbo', 'image-replicate-ideogram-ai/ideogram-v4-turbo', ['src/cli/create-cli.ts', 'image', 'The word TURBO centered in a clean typographic poster', '--provider', 'replicate=ideogram-ai/ideogram-v4-turbo', '--size', '2048x2048', '--price']),
    command('image-replicate-ideogram-ai/ideogram-v4-balanced', 'image-replicate-ideogram-ai/ideogram-v4-balanced', ['src/cli/create-cli.ts', 'image', 'The word BALANCED centered in a clean typographic poster', '--provider', 'replicate=ideogram-ai/ideogram-v4-balanced', '--size', '2048x2048', '--price']),
    command('image-replicate-ideogram-ai/ideogram-v4-quality', 'image-replicate-ideogram-ai/ideogram-v4-quality', ['src/cli/create-cli.ts', 'image', 'The word QUALITY centered in a clean typographic poster', '--provider', 'replicate=ideogram-ai/ideogram-v4-quality', '--size', '2048x2048', '--price']),
