...
export const imageRegistry: PriceSelectionEntry[] = [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/grok-imagine-image-quality.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/bfl-flux-2-pro.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/bfl-flux-2-klein.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/bfl-flux-2-max.test.ts', [
  ...
  ...exact('test/test-cases/e2e/service/visuals/image/bfl-flux-2-flex.test.ts', [
