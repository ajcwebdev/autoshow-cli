import type {
  ...
  BudgetSkippedEntry,
  GroupedPriceCommandEntries,
  PriceCommandKeySummary,
  PriceCommandKeyedEntry,
...
export const groupCommandsByKey = <T extends PriceCommandKeyedEntry>(commands: T[]): GroupedPriceCommandEntries<T>[] => {
