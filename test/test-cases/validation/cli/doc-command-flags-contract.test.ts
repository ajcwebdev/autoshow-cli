...
const commandByDoc = {
  ...
  '02-extract/stt/overview.md': extractCommand,
  ...
  '02-extract/stt/workflows/transcript-video/overview.md': extractCommand,
  '02-extract/ocr/overview.md': extractCommand,
  '02-extract/url/overview.md': extractCommand,
  '03-write/overview.md': writeCommand,
