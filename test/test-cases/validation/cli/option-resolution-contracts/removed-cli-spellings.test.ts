...
const UNKNOWN_FLAGS: Array<{ argv: string[], flag: string }> = [
  ...
  { argv: ['tts', 'input/examples/tts/1-tts.md', '--minimax-tts-volume', '1'], flag: '--minimax-tts-volume' },
  { argv: ['tts', 'input/examples/tts/1-tts.md', '--minimax-tts-pitch', '0'], flag: '--minimax-tts-pitch' },
  { argv: ['tts', 'input/examples/tts/1-tts.md', '--minimax-tts-emotion', 'happy'], flag: '--minimax-tts-emotion' },
  { argv: ['tts', 'input/examples/tts/1-tts.md', '--minimax-tts-pronunciation', 'autoshow/auto show'], flag: '--minimax-tts-pronunciation' },
