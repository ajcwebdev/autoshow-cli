...
describe('option resolution contracts', () => {
  test('hosted TTS exposes exactly the 11 active providers', () => {
    expect(TTS_PROVIDERS).toEqual(['elevenlabs', 'minimax', 'grok', 'mistral', 'openai', 'speechify', 'hume', 'cartesia', 'fish', 'inworld', 'deepinfra'])
