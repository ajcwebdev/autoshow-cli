...
describe('option resolution contracts', () => {
  ...
  test('--all-stt/--all-ocr expand hosted providers and local shortcuts expand local engines', () => {
      ...
      expect(ocrOpts.deepinfraOcrModels).toEqual(['google/gemma-4-31B-it', 'Qwen/Qwen3.8-27B', 'deepseek-ai/DeepSeek-V4.1-Flash'])
      expect(expansions['deepinfra-stt']?.supported).toEqual(['openai/whisper-large-v3-turbo', 'openai/whisper-large-v3', 'Qwen/Qwen3-ASR-0.6B', 'Qwen/Qwen3-ASR-1.7B', 'mistralai/Voxtral-Mini-3B-2507', 'mistralai/Voxtral-Small-24B-2507', 'nvidia/Nemotron-3.5-ASR-Streaming-Multilingual-0.6b'])
      expect(expansions['openai-stt']?.shortcut).toBe('all-stt')
      expect(expansions['openai-stt']?.supported).toEqual(['gpt-transcribe'])
      expect(sttOpts.openaiSttModels).toEqual(['gpt-transcribe'])
