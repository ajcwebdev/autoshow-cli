...
describe('option resolution contracts', () => {
  ...
  test('--all-llm expands OpenAI, Anthropic, Grok, GLM, Kimi, Together to their supported models', () => {
      ...
      expect(opts.anthropicModels).toEqual(['claude-fable-5-1', 'claude-fable-5', 'claude-opus-4-8', 'claude-sonnet-5', 'claude-sonnet-4-6', 'claude-haiku-4-5', 'claude-opus-5'])
      expect(opts.anthropicModels).not.toContain('claude-mythos-5')
      expect(opts.geminiModels).toEqual(['gemini-3.1-pro-preview', 'gemini-3.8-flash', 'gemini-3.7-flash', 'gemini-3.6-flash', 'gemini-3.5-flash', 'gemini-3.5-flash-lite'])
