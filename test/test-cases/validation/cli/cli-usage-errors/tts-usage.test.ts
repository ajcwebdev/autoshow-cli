...
import { runSingleTtsInput } from '~/cli/commands/audio/tts/define-tts-command'
...
import { assertDialogueFormatIsUsable } from '~/cli/commands/audio/tts/dialogue-normalizer'
