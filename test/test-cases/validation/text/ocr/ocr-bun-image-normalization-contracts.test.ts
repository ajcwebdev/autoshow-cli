...
} from '~/cli/commands/text/ocr/ocr-utils/bun-image-utils'
import {
  normalizeHostedDirectImageInput,
  resolveHostedDirectImageInputStrategy
} from '~/cli/commands/text/ocr/hosted-ocr'
...
describe('OCR Bun.Image normalization contracts', () => {
  ...
  test('installed Bun 1.4 declarations replace all local Image constructor shims', async () => {
    ...
    for (const path of [
      'src/cli/commands/text/ocr/ocr-utils/bun-image-utils.ts',
      'src/cli/commands/visuals/comic/comic-image-services/image-writer.ts',
      'src/cli/commands/visuals/comic/comic-commands/character-sketch/character-sketch-sheet.ts'
    ]) {
