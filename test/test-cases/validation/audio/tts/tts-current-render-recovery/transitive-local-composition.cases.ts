...
import { writeGenerationMetadata } from '~/cli/commands/command-shared/generation-command-utils'
import { PIPELINE_MANIFEST_FILE, readManifest, writeManifest } from '~/cli/commands/command-shared/pipeline-manifest'
...
import { createGenericTtsDialoguePlan, createInlineTtsSourceIdentity } from '~/cli/commands/audio/tts/script-to-audio/generic-dialogue-plan'
...
import { canonicalTtsJson, hashCanonicalRecordWithout, hashCanonicalTtsValue, sha256Bytes } from '~/cli/commands/audio/tts/script-to-audio/contract-identity'
import type {
