...
import { resolveTtsOutputLayout } from '~/cli/commands/audio/tts/script-to-audio/tts-output-layout'
...
import { SOUND_EFFECT_ARCHIVE_PATH, createSoundEffectRenderPlan, executeSoundEffectRenderPlan, loadCompactSfx, planSoundEffectResumePrice, soundEffectSourcePath, soundEffectWorkingRoot } from '~/cli/commands/audio/tts/soundscape/sound-effect-execution'
import { DEFAULT_COMIC_SOUNDSCAPE_MIX_PROFILE } from '~/cli/commands/audio/tts/soundscape/soundscape-planner'
import { PRESENTATION_ARCHIVE_PATH, loadCompactPresentation } from '~/cli/commands/visuals/comic/comic-utils/comic-presentation-renderer'
...
describe('ADR-012 compact archive contracts', () => {
