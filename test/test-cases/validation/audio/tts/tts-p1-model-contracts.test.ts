...
import { buildProviderSerializerDescriptor } from '~/cli/commands/audio/tts/script-to-audio/provider-serializer-registry'
import { computePaidSpeechSlotHash, hashCanonicalTtsValue } from '~/cli/commands/audio/tts/script-to-audio/contract-identity'
