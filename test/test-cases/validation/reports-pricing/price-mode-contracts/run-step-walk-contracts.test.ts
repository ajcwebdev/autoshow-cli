...
const fixture = {
  ...
  step2: [{
    ...
    transcriptionModel: '/models/whisper-large-v3.llamafile',
    processingTime: 1200,
    tokenCount: 120,
  ...
  partialStep2: {
    ...
    artifactDir: 'providers/openai-gpt-5.6-luna',
    completedPages: 2,
    failedPages: 1,
