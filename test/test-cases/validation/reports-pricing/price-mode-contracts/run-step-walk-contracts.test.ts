...
describe('actual run-step walker contracts', () => {
  test('cost and timing preserve their serialized valid-run projections', () => {
    expect(JSON.stringify(computeActualCosts(fixture))).toBe('{"totalCost":28.2633,"steps":[{"step":"extract","provider":"openai","model":"gpt-5.4-nano","cost":3,"costSource":"partial_provider_usage","inputMetric":"tokens","inputValue":45,"promptTokens":30,"completionTokens":15},{"step":"stt","provider":"whisperfile","model":"large-v3","cost":1,"costSource":"provider_quote","inputMetric":"durationSeconds","inputValue":12},{"step":"stt","provider":"whisperfile","model":"tiny","cost":2,"costSource":"provider_quote","inputMetric":"durationSeconds","inputValue":12},{"step":"llm","provider":"openai","model":"gpt-5.4-nano","cost":0.0033,"costSource":"computed_usage","inputMetric":"tokens","inputValue":60,"promptTokens":40,"completionTokens":20},{"step":"tts","provider":"openai","model":"gpt-4o-mini-tts-2025-12-15","cost":1.26,"costSource":"computed_usage","inputMetric":"characters","inputValue":1000},{"step":"image","provider":"openai","model":"gpt-image-2","cost":6,"costSource":"provider_quote","inputMetric":"images","inputValue":1},{"step":"video","provider":"gemini","model":"veo-test","cost":7,"costSource":"provider_quote","inputMetric":"durationSeconds","inputValue":7},{"step":"music","provider":"gemini","model":"lyria-test","cost":8,"costSource":"provider_quote","inputMetric":"durationMs","inputValue":8000}]}')
