...
export const FAL_IMAGE_LINKS = sectionLinks('Fal', 'Image')
export const FAL_VIDEO_LINKS = sectionLinks('Fal', 'Video')

export const BFL_IMAGE_LINKS = sectionLinks('BFL', 'Image')
export const BFL_ALL_LINKS = providerLinks('BFL')
