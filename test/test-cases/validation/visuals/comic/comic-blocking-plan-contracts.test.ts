...
import { generateBlockingPlan, estimateBlockingPlanCalls } from '~/cli/commands/visuals/comic/comic-commands/draft-scenes/generate-blocking-plan'
import { BLOCKING_GEOMETRY, axisSideForCamera, cameraBasis, cameraHeadingDeg, facingRelativeToCamera, nearestRegisteredView, pointInFootprint, projectAnchor, projectPoint } from '~/cli/commands/visuals/comic/comic-utils/blocking-geometry'
