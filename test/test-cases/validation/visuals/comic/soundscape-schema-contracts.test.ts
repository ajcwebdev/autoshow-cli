...
import { createStructuredScriptArtifactRef, computeSceneRunIdentity, validateStructuredScriptSourceSpans } from '~/cli/commands/visuals/comic/comic-utils/comic-audio-contracts'
...
import { StructuredScriptDataSchema } from '~/cli/commands/visuals/comic/schemas/schemas'
