...
import { auditComicSceneArtifactLineage, soundscapeAudioRunLineageRefs } from '~/cli/commands/visuals/comic/comic-utils/comic-artifact-lineage-audit'
import { createStructuredScriptArtifactRef, computeSceneRunIdentity } from '~/cli/commands/visuals/comic/comic-utils/comic-audio-contracts'
import { createComicDialoguePlan } from '~/cli/commands/visuals/comic/comic-utils/comic-dialogue-plan'
import { updateComicAudioManifest, updateComicPresentationManifest, writeInitialComicStructureManifest } from '~/cli/commands/visuals/comic/comic-utils/comic-manifest'
import { createLocalSilentDialogueRun, runComicSoundscape } from '~/cli/commands/visuals/comic/comic-utils/comic-soundscape-workflow'
import { parseScriptMarkdownToStructuredData } from '~/cli/commands/visuals/comic/comic-utils/structured-script-utils/structured-script-parser'
import { createElevenLabsSoundEffectAdapter, resolveSoundEffectTarget } from '~/cli/commands/audio/tts/soundscape/elevenlabs-sfx-adapter'
import { createSoundEffectRenderPlan } from '~/cli/commands/audio/tts/soundscape/sound-effect-execution'
import { createSoundscapePlan } from '~/cli/commands/audio/tts/soundscape/soundscape-planner'
import { canonicalTtsJson, hashCanonicalTtsValue } from '~/cli/commands/audio/tts/script-to-audio/contract-identity'
import { PRESENTATION_ARCHIVE_PATH, PRESENTATION_FINAL_MP4, PRESENTATION_FINAL_WAV } from '~/cli/commands/visuals/comic/comic-utils/comic-presentation-renderer'
import { writeImmutableArtifactFile, writeReplaceableArtifactFile } from '~/cli/commands/audio/tts/script-to-audio/safe-artifact-store'
