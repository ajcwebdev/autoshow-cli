...
} from '~/cli/commands/visuals/comic/comic-utils/comic-presentation-plan'
import { assertPresentationSoundEffectResult, loadCanonicalPresentationPanels, loadPresentationAudio, preparePresentationVisualInputs, resolvePresentationVisualInputs, selectPresentationAudioBinding } from '~/cli/commands/visuals/comic/comic-utils/comic-presentation-inputs'
import { createLocalSilentDialogueRun } from '~/cli/commands/visuals/comic/comic-utils/comic-soundscape-workflow'
import { createStructuredScriptArtifactRef } from '~/cli/commands/visuals/comic/comic-utils/comic-audio-contracts'
...
import { updateComicPresentationManifest, writeInitialComicStructureManifest } from '~/cli/commands/visuals/comic/comic-utils/comic-manifest'
import { readManifest } from '~/cli/commands/command-shared/pipeline-manifest'
import { canonicalTtsJson } from '~/cli/commands/audio/tts/script-to-audio/contract-identity'
import { writeImmutableArtifactFile } from '~/cli/commands/audio/tts/script-to-audio/safe-artifact-store'
