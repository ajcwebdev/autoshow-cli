...
import { draftScenesCommand } from '~/cli/commands/visuals/comic/comic-commands/draft-scenes/draft-scenes-command'
import { generateImagesCommand } from '~/cli/commands/visuals/comic/comic-commands/generate-images/generate-images-command'
import { comicLog } from '~/cli/commands/visuals/comic/comic-utils/comic-logger'
...
import { getSceneOutputDirectory } from '~/cli/commands/visuals/comic/comic-utils/project-paths'
import type {
  ImageRunStats,
