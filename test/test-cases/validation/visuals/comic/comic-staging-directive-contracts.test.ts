...
import { validateStructuredScriptSourceSpans } from '~/cli/commands/visuals/comic/comic-utils/comic-audio-contracts'
import { StructuredScriptDataSchema, StructuredStagingSchema } from '~/cli/commands/visuals/comic/schemas/schemas'
import { reviewStructuredScriptWithLlm } from '~/cli/commands/visuals/comic/comic-utils/structured-script-utils/llm-review'
import { normalizeStructuredScriptData } from '~/cli/commands/visuals/comic/comic-utils/structured-script-utils/structured-data-normalization'
import { parseScriptMarkdownToStructuredData as parseStructuredScript } from '~/cli/commands/visuals/comic/comic-utils/structured-script-utils/structured-script-parser'
import { STAGING_DIRECTIVE_LABELS, STAGING_HEADER_KEYS, parseStagingBlockDirective } from '~/cli/commands/visuals/comic/comic-utils/structured-script-utils/staging-directives'
import type { CharacterCatalogService, ComicStructuredLlmResult, StructuredScriptData } from '~/types'

const fixtureRoot = 'test/test-cases/validation/visuals/comic/fixtures/structured-script-parser'
