...
} from '~/cli/commands/audio/tts/soundscape/replicate-audiogen-adapter'
import { createSoundEffectRenderPlan, executeSoundEffectRenderPlan, loadSoundEffectRenderPlan, loadSoundEffectRenderResult, writeSoundEffectRenderPlan } from '~/cli/commands/audio/tts/soundscape/sound-effect-execution'
import { createSoundscapePlan } from '~/cli/commands/audio/tts/soundscape/soundscape-planner'
import { createComicSourceIdentity, createStructuredScriptArtifactRef, computeSceneRunIdentity } from '~/cli/commands/visuals/comic/comic-utils/comic-audio-contracts'
import { createComicDialoguePlan } from '~/cli/commands/visuals/comic/comic-utils/comic-dialogue-plan'
import { createLocalSilentDialogueRun, planComicSoundscapePrice, resolveSoundEffectPlan, runComicSoundscape } from '~/cli/commands/visuals/comic/comic-utils/comic-soundscape-workflow'
...
describe('ADR-013 Phase 7E Replicate AudioGen soundscape acceptance', () => {
