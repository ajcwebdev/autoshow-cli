...
} from '~/cli/commands/visuals/comic/comic-utils/source-coverage-utils'
...
const structuredScriptFixtureRoot = 'test/test-cases/validation/visuals/comic/fixtures/structured-script-parser'
