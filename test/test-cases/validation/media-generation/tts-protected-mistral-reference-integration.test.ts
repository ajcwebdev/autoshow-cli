...
import type { CanonicalAudioProviderProjection, ProtectedAssetRef, TtsCliReferenceInput, TtsOptions, TtsTarget, TtsTargetInvocation } from '~/types'
import { createProtectedVoiceAssetStore, type ProtectedVoiceAssetStore } from '~/cli/commands/process-steps/step-4-tts/voice-assets/protected-voice-asset-store'
