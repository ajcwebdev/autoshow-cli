...
export type Step2Metadata = {
  ...
  transcriptionService: 'whisperfile' | 'deepgram' | 'deepinfra' | 'soniox' | 'speechmatics' | 'rev' | 'grok' | 'mistral' | 'assemblyai' | 'gladia' | 'happyscribe' | 'supadata' | 'scrapecreators' | 'gemini-stt' | 'together' | 'openai-stt' | 'youtube-captions'
  ...
  billing?: {
    ...
    source?: 'provider_usage' | 'provider_quote' | 'response_header' | 'registry_fallback' | undefined
