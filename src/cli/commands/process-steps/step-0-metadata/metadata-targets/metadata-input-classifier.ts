...
export const isRawXSpaceId = (input: string): boolean =>
  RAW_X_SPACE_ID_PATTERN.test(input.trim())
...
const resolveDetectResultFromExtension = (
  ...
  const ebookFormat = resolveConvertibleEbookFormatFromExtension(lower)
