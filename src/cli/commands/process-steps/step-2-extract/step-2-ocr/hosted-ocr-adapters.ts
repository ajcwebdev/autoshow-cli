...
type HostedOcrFallbackOptions = Pick<
  RunHostedOcrPdfChunkFallbackOptions,
...
export const HOSTED_OCR_ADAPTERS: readonly HostedOcrAdapterDescriptor[] = [
  {
    ...
    engine: 'mistral-ocr',
    label: 'Mistral OCR',
    limitSource: 'project/links/mistral-general-ocr-links.md',
  ...
  },
  {
    ...
    engine: 'glm-ocr',
    label: 'GLM OCR',
    limitSource: 'project/links/glm-all-links.md',
  ...
  },
  {
    ...
    engine: 'openai-ocr',
    label: 'OpenAI OCR',
    limitSource: 'project/links/openai-general-ocr-text-links.md',
    directImageFormats: ['png', 'jpg', 'webp', 'gif'],
