...
export const writeCommand = defineCliCommand({
  ...
  help: {
    examples: [
      ['bun autoshow write https://youtube.com/watch?v=abc', 'Full pipeline with default local models'],
      ...
      ['bun autoshow write input/examples/document/1-epub.epub --epub-bun --llm llama --format json', 'Inspect EPUB structure, then summarize it with the default local llama model'],
