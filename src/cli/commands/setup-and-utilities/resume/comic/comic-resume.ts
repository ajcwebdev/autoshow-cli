...
import { configurePinnedRunDir, getPinnedRunDir, resetPinnedRunDir } from '../../../process-steps/run-dir'
import { configureCharactersRoot, getCharactersRoot } from '../../../process-steps/characters-root'
import { beginSceneRun, resetSceneRunContext } from '../../../process-steps/step-8-comic/comic-utils/scene-run-context'
import { resolveCompatibleComicSceneRun } from '../../../process-steps/step-8-comic/comic-utils/compatible-scene-run'
import { readManifest } from '../../../process-steps/pipeline-manifest'
import { validateComicRecoveryInputs } from '../../../process-steps/step-8-comic/comic-utils/comic-recovery-intent'
import { captureComicImageRecoveryInputs, comicImageRecoveryHash } from '../../../process-steps/step-8-comic/comic-utils/comic-image-recovery'
import { coerceAndValidateGenerateImages } from '../../../process-steps/step-8-comic/comic-utils/cli-args'
import { generateImagesCommandDefinition, generateAudioCommandDefinition, generateSlideshowCommandDefinition } from '../../../process-steps/step-8-comic/comic-utils/subcommand-help'
import { generateImagesCommand } from '../../../process-steps/step-8-comic/comic-commands/generate-images/generate-images-command'
import { generateComicAudio } from '../../../process-steps/step-8-comic/comic-commands/generate-audio/generate-audio-command'
import { planComicAudio } from '../../../process-steps/step-8-comic/comic-commands/generate-audio/comic-audio-planning'
import { generateComicSlideshow, planComicSlideshow } from '../../../process-steps/step-8-comic/comic-commands/generate-slideshow/generate-slideshow-command'
import { resolvePresentationVisualInputs } from '../../../process-steps/step-8-comic/comic-utils/comic-presentation-inputs'
import { loadCompactPresentation, selectPresentationVideoEncoder } from '../../../process-steps/step-8-comic/comic-utils/comic-presentation-renderer'
import { canonicalTtsJson, hashCanonicalTtsValue } from '../../../process-steps/step-4-tts/script-to-audio/contract-identity'
