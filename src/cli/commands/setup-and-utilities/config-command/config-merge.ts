...
export const FLAG_TO_CONFIG_PATH: Record<string, string[]> = {
  ...
  'tts-channels': ['defaults', 'tts', 'channels'],
  'tts-loudness': ['defaults', 'tts', 'loudness'],
  'tts-true-peak': ['defaults', 'tts', 'truePeak'],
  'tts-trim-silence': ['defaults', 'tts', 'trimSilence'],
  'tts-paragraph-pause': ['defaults', 'tts', 'paragraphPause'],
  'tts-sentence-pause': ['defaults', 'tts', 'sentencePause'],
  'tts-lead-in': ['defaults', 'tts', 'leadIn'],
  'tts-lead-out': ['defaults', 'tts', 'leadOut'],
  'tts-chunk-boundary': ['defaults', 'tts', 'chunkBoundary'],
  'tts-chunk-size': ['defaults', 'tts', 'chunkSize'],
  'tts-text-preflight': ['defaults', 'tts', 'textPreflight'],
  'tts-export-format': ['defaults', 'tts', 'exportFormat'],
  'tts-bitrate': ['defaults', 'tts', 'bitrate'],
