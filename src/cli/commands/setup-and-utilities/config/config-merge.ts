...
export const FLAG_TO_CONFIG_PATH: Record<string, string[]> = {
  ...
  'replicate-video-generate-audio': ['defaults', 'post', 'video', 'replicateVideoGenerateAudio'],
  'replicate-video-reference-video': ['defaults', 'post', 'video', 'replicateVideoReferenceVideos'],
  'replicate-video-reference-audio': ['defaults', 'post', 'video', 'replicateVideoReferenceAudios'],
