...
import { managedVoiceAssetStore } from '../../../audio/voice/managed-voice-store'
import { loadVoiceConsentRecord } from '../../../audio/voice/voice-consent-store'
import { assertVoiceConsentAllows } from '../../../audio/voice/voice-management-contracts'
import {
  loadApprovedVoiceAudition,
  loadCharacterVoiceBriefCatalog,
  loadCurrentVoiceRegistrationIndex,
  loadVoiceRegistrationCatalog,
} from '../../../audio/voice/character-voice-registry'
import { canonicalTtsJson, hashCanonicalTtsValue, sha256Bytes } from '../../../audio/tts/script-to-audio/contract-identity'
import { writeImmutableArtifactFile } from '../../../audio/tts/script-to-audio/safe-artifact-store'
import {
