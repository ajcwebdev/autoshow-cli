import { collectLlmTargets } from '~/cli/commands/text/write/run-llm'
...
import { runSchemaGuidedFallback } from '~/cli/commands/text/write/structured-output/schema-guided-fallback'
