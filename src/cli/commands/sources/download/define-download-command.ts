...
export const downloadCommand = defineCliCommand({
  ...
  help: {
    examples: [
      ...
      ['bun autoshow download https://example.com/feed --batch-limit all --keep-original-media --flat-batch', 'Download all podcast episode files into one batch directory'],
