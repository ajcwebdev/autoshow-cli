...
const collectXSpacesArtifact = async (
  ...
  const [
    ...
    import('~/cli/commands/text/url/url-services/x-spaces/input'),
    import('~/cli/commands/text/url/url-services/x-spaces/x-spaces-client'),
    import('~/cli/commands/text/url/url-services/x-spaces/x-spaces-collect')
  ])
...
const collectAndWriteXSpaceExtraction = async (
  ...
  const { renderSpacesJson, renderSpacesMarkdown } = await import('~/cli/commands/text/url/url-services/x-spaces/report')
...
export const resolveXSpaceDownloadTarget = async (target: string): Promise<string> => {
  const { parseSpaceInput } = await import('~/cli/commands/text/url/url-services/x-spaces/input')
  const parsedInput = parseSpaceInput(target)
