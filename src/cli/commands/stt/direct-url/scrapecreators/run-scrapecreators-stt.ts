...
import { buildTranscriptionOutputBase, countTokens, formatTranscriptText, resolveTranscriptionOutput, toTimestamp } from '~/cli/commands/stt/stt-utils/stt-utils'
...
export const runScrapeCreatorsStt = async (
  ...
  const requestUrl = buildScrapeCreatorsUrl(getScrapeCreatorsBaseUrl(baseUrl), sourceUrl as string, language)
  let requestCount = 0
  let retryCount = 0
