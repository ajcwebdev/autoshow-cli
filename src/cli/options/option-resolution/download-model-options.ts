...
export const readRuntimeModelOptions = (
  ...
  return {
    ...
    openaiSttModels: readValidatedMany('openai-stt', validateOpenAISttModel),
    ...
    sonioxTtsModels: readValidatedMany('soniox-tts', validateSonioxTtsModel),
